...
\date{December 11, 2025\\Version 4.6}
...
\begin{description}[style=nextline]
    ...
    \item[Spellbook] Source material for learning (12 Acts + bookends = 13 sections, plus 30 tales in Zero Spellbook)
...
The privacymage spellbook (Acts 1--12) functions as semantic infrastructure.
...
\begin{itemize}
    ...
    \item \textbf{Research Paper:} v3.4 (companion document)
...
\textbf{4.6} & \textbf{Dec 11, 2025} & \textbf{Review revisions: Added notation key, qualified value claims, added implementation challenge for conditional independence, added trust tier rationale, clarified personhood dependency, labeled tetrahedral section as speculative} \\
\bottomrule
\end{tabular}
\end{center}
