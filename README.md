...
|------|---------|--------------|
| **Blade** 🗡️ | 0-50 | Basic participation, learning |
| **Light** 🛡️ | 50-150 | Multi-site coordination, Intel Pool contributions |
| **Heavy** ⚔️ | 150-500 | Template creation, governance voting |
| **Dragon** 🐉 | 500+ | Guardian eligibility, unlimited VRCs, custom spells |
...
1. Research Paper v3.2 (mathematical foundations)
2. Whitepaper v4.3 (architecture)
3. Research Proposal v1.1 (collaboration opportunities)

### For Developers / Builders
1. Visual Guide v1.1 (quick orientation)
2. Whitepaper v4.3 (technical details)
3. Tokenomics v2.0 (economic mechanics)

### For Investors / Advisors
1. This README (summary)
2. Tokenomics v2.0 (economics)
3. Research Proposal v1.1 (roadmap)

### For Community / Learners
1. Spellbook v4.0.0-canonical (narrative framework)
2. Visual Guide v1.1 (diagrams)
3. Glossary v2.0 (terminology reference)
...
## Document Coherence (November 25, 2025)

This documentation suite has been reviewed for terminology consistency, economic parameter alignment, and cross-reference accuracy.
