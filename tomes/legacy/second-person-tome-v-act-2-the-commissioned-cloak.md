...
- *Primary sources*: VRC Promise Protocol v3.3 (the trust edge as VRC). the Archon forge's multi-chain publication discipline (the *like Archon does* framing).
