...
|-----------|------|---------|
| [2026-06-10_swordsmans_key_holospace_sigil.md](2026-06-10_swordsmans_key_holospace_sigil.md) | 2026-06-10 | **The Swordsman's Key becomes a browser compute surface** — /star+/lattice extracted to public `github.com/mitchuski/star`, merged over UOR holospaces; κ-labels on City Keys (sha256 of canonical form, Law-L5 re-derivation, conformance vector pinned); /sigil third projection (64 hash glyphs ↔ 64 vertices · C85 in UI · V5.4 §12.6 dimensions named); the sigil **PNG carries the key** (tEXt chunk) — importable on all pages + chargeable at /city; redacted charge-only carrier flagged as next rung |
| [2026-05-28_release_city_key_suite_all_repos_sync.md](2026-05-28_release_city_key_suite_all_repos_sync.md) | 2026-05-28 | **RELEASE MANIFEST** — the single cross-repo handoff for the City Key arc: per-repo file inventory (agentprivacy_master · spellweb · cityofmages · agentprivacy-docs · star lattice · soulbis), build/push notes, deploy order, verification status, and known-pending. Work from this file alone to push to prod |
| [2026-05-28_the_eight_pointed_star_city_key_capstone.md](2026-05-28_the_eight_pointed_star_city_key_capstone.md) *(in cityofmages/chronicles)* | 2026-05-28 | Tome VIII Act 3 *The Eight-Pointed Star* — Luca teaches the stella octangula; the City Key forged from it; the narrative capstone of the build |
| [2026-05-28_city_key_economy_charge_stake_workshop_trust_task_chronicle.md](2026-05-28_city_key_economy_charge_stake_workshop_trust_task_chronicle.md) | 2026-05-28 | The City Key becomes a round-trip **economy**: **Charge** (earn 🪢 from soulbis `trace`) + **VRC committed-staking** (earned/committed/free · `focus` distribution carried in the key) + the **Presence-vs-Artefact** workshop ontology and the `WorkshopTrustTask` 5-step gate chain (Presence root → discover/trace/home → cast → City Key). Counter fix · cast-gating · presented-artefacts accessor |
| [2026-05-27_swordsman_key_producer_and_ceremony_surfacing_chronicle.md](2026-05-27_swordsman_key_producer_and_ceremony_surfacing_chronicle.md) | 2026-05-27 | The Swordsman's Key **producer built** (`lib/swordsmans-key.ts`) + surfaced on three identity surfaces (`/guide/achievements §2` gated · `/ceremony` CompletionStep + SwordsmanAccountSettings); export-vs-navigate split (one "Export to Soulbis" + Star/Lattice journey links); palette reconciled to coral/cyan + navy→white; sparse descriptions + additive `lit[]`/`identity{}`; `drakeOrbTier`→`drakeOrb` V63 fix |
| [2026-05-27_star_lattice_swordsman_key_integration_chronicle.md](2026-05-27_star_lattice_swordsman_key_integration_chronicle.md) | 2026-05-27 | Star lattice ⇄ Swordsman's Key suite integration: consumer shipped on `soulbis.com/star`+`/lattice`, names the new **Swordsman's Key export type** owed by `/guide/achievements` (the producer), and the spellweb `key`/`gateway` vocabulary the bridge needs |
...
**City of Mages grimoire — current head:** **v1.6.0** (PINNED 2026-05-14) at `bafybeiap6kvy3tp2bndpk65ti57qngr7ill37gqgasp2sxmgder3akotru` (`sync.agentprivacy.ai`). Source-of-truth: `cityofmages/grimoire/city_of_mages_grimoire_v1_6_0.json`. Consolidated new-head supersession of v1.5.0 + v1.5.1 patches (neither pinned independently) plus the 2026-05-14 six canonical moves: **Threshold District restructure** (Pandia 🌕 + Hermaion ⚚ + Faunia-at-Familiars 🪶 at V59 · three sibling shops · stance-differentiated) · **archetype-modal-shop pattern** (Staff Shop with Alexandrite dual-aspect green-Mage `#3d7c47` ↔ red-Swordsman `#a23a3a` · Caducea ☤ fits both) · **Chart Shop opens at V44** (Pleione 🧭 · Aquamarine · Hold-witness · Navigation District) · **C58 promoted to ~85%** (Forge(t) ∥ Threshold sibling Swordsman-suppliers) · **C63 registered as candidate ~50%** (attentional workshop register as fourth structural workshop class). Historical pointers: v1.4.0 PINNED 2026-05-12 (Solchanting + Helia + Tome VII Act 1); v1.2-1.3 mirrors retained.

**Spellweb v1.6.0 sync (2026-05-14):** new EdgeTypes `keeps · wields · sibling_of · district_of · fits_for · succeeded_by · releases_to` admitted; new SpellwebNode fields `gemColorMage · gemColorSwordsman · archetypeModal · district` admitted. Workshop nodes added: `shop-solchanting · shop-portal-room · shop-staff-shop · shop-familiars · shop-charthouse`. Cast nodes added: `cast-helia · cast-pandia · cast-hermaion · cast-faunia · cast-caducea · cast-pleione` plus historical-superseded `cast-bestia · cast-therai · cast-pelagia` for succession edges. See [CHRONICLE_CITY_OF_MAGES_V1_6_0_SYNC_2026-05-14.md](CHRONICLE_CITY_OF_MAGES_V1_6_0_SYNC_2026-05-14.md).
...
| [CHRONICLE_MOON_PHASE_FORGE_2026-04-07.md](CHRONICLE_MOON_PHASE_FORGE_2026-04-07.md) | 2026-04-07 | Moon phase forge implementation, stratum visibility encoding |
| [CHRONICLE_MOON_PHASE_SYNC_2026-04-07.md](CHRONICLE_MOON_PHASE_SYNC_2026-04-07.md) | 2026-04-07 | Cross-repository moon phase synchronisation |
