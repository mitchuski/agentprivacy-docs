...
- `vrc-protocol-spec` — spec · DOCS `specs/vrc_promise_protocol_v3_3.md` (VRC lifecycle, RPP, dual-token economics).
...
- `dream-chronicles` — process-record · DOCS `chronicles/DREAM-2026-06-29.md`, `DREAM-2026-07-01.md`; COM copies; SOULBIS `chronicles/DREAM-2026-06-29.md`.
