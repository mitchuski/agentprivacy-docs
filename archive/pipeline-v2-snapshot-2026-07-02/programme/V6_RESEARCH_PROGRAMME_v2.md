...
## Part C · The extraction map, widened (E1 to E9)

The three v1 extractions carry. Six more complete the net across the V4 to V6 lineage. Each lists sources, contents, and its downstream artifacts.
