...
wp: WP-27
tier: A
artifact: methods-paper
title: "Conjecture Governance: an Operating Method for Agent-Generated Research, with a Non-Delegable Completion Gate"
status: draft-v3
role: A2 (register translation from E10); A3 (formal pass 2026-07-10, four stubs discharged as Definitions 1-4 / invariants I1-I12, theorem-discipline sweep); A3 + A2 (revision 1 legs of the L107 loop, 2026-07-10)
date: 2026-07-10
gate_target: awaiting-P4 (P0/P1/P2/P3 on file, L104-L110; P4 is the First Person's; the runtime stops here)
handoff: the P4 owner (venue = meta-research/methods class, due 2027-Q3; record-availability decision rides the first-person acts per L107(2))
venue_target: meta-research / research-methods venue
extraction_basis: E10 claims C01-C24, C26-C30 consumed; E10-C25 consumed for its dating evidence only; E10-C31 not consumed (reasons in trace map); novelty fence = reviews/WP-27_prior_art.md, N1-N4 / S1-S6, binding; circuit-workshop instance carried at claim level only per its integrity fence
scaffold: methods-paper skeleton per task card WP-27_A2_draft_2026-07-10
---

# Conjecture Governance: an Operating Method for Agent-Generated Research, with a Non-Delegable Completion Gate
