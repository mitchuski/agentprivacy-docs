...
artefact: companion-methods-document
tier: internal
register: academic-support
role: session companion (first-person commissioned, 2026-08-17)
date: 2026-08-17
status: draft-v1
note: "Companion to the tier-A papers WP-04, WP-07, WP-11, WP-14, WP-27 and their supporting artefacts. Describes the production method: the V6 Rehydration Pipeline (roles, gates, checks, ledger, chronicles) and the adversarial literature-review runtimes (runs 02 and 03). This document is descriptive of the machinery; the machinery's own methods paper, written to methods-venue standard, is WP-27 (conjecture_governance_method.md). Where the two overlap, WP-27 governs."
---
